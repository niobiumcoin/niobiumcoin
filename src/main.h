...
static const int64_t MAX_SINGLE_TX = 10000000 * COIN; // 10 Million Niobium coins
/** Moneyrange params */
...
static const int64_t COIN_SPRB_REWARD = 35 * CENT; // 35% superblock
/** Block spacing preferred */
static const int64_t BLOCK_SPACING = 1.5 * 60;
/** Block spacing minimum */
static const int64_t BLOCK_SPACING_MIN = 1 * 60;
/** Block spacing maximum */
static const int64_t BLOCK_SPACING_MAX = 2 * 60;
/** Darksend collateral */
...
inline int64_t MasternodeCollateral(int nHeight) { return 1500; } // 50K Nb required as collateral
...
static const int64_t nBlockRewardReserve = 50000 * COIN; //
/** Starting block subsidy */
static const int64_t nBlockPoWReward = 0.01 * COIN;
/** Superblock subsidy */
static const int64_t nSuperPoWReward = 0.10 * COIN;
...
bool AcceptToMemoryPool(CTxMemPool& pool, CTransaction &tx, bool fLimitFree,
                        bool* pfMissingInputs, bool fRejectNiobiumFee=false, bool ignoreFees=false);

bool AcceptableInputs(CTxMemPool& pool, const CTransaction &txo, bool fLimitFree,
                        bool* pfMissingInputs, bool fRejectNiobiumFee=false, bool isDSTX=false);
...
public:
    ...
    bool AcceptToMemoryPool(bool fLimitFree=true, bool fRejectNiobiumFee=true, bool ignoreFees=false);
